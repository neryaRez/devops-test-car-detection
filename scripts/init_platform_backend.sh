...
STATE_KEY="platform/${ENVIRONMENT}/terraform.tfstate"

echo "Initializing platform backend:"
...
BACKEND_FILE="$BACKEND_DIR/platform.hcl"
...
echo "Platform backend initialized successfully."